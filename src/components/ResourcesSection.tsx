...
const ResourcesSection = () => {
  ...
  const [showRegulatoryIntro, setShowRegulatoryIntro] = useState(false);

  const handleRegulatoryClick = () => {
    setShowRegulatoryIntro(true);
  };

  const handleRegulatoryIntroClose = () => {
    setShowRegulatoryIntro(false);
    setOpenDialog("regulatory");
  };
  ...
  return (
    <section className="py-20 bg-transparent">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          {resources.map((resource, index) => {
            ...
            return (
              <div
                key={index}
                onClick={() => resource.dialogType === "regulatory" ? handleRegulatoryClick() : setOpenDialog(resource.dialogType)}
      ...
      <Dialog open={showRegulatoryIntro} onOpenChange={(isOpen) => { if (!isOpen) handleRegulatoryIntroClose(); }}>
